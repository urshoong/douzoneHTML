...
export function DaumPost(props){
    ...
    return (
        ...
        /* 
        <>
            <Button icon={<SearchOutlined />} onClick={showModal}>위치 검색</Button>
            
            <Modal title="다음 우편 주소 검색" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
        ...
        //bootstrap
        <>
            <Button variant="primary" onClick={showModal}>위치 검색</Button>
